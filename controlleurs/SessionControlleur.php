<?php
	...
	class SessionsControlleur extends controlleur
	{
		...
		* user login action
		*/
		public function login($login, $password, $tab="utilisateurs", $key1="email", $key2="motdepasse")
		{
		...
		*/
		public function isUser($session_hash, $tab="utilisateurs")
		{
			...
			if ( $u )
			{
				...
				$computed_hash = hash( 'sha256', $m->email . $m->motdepasse . $_SERVER['REMOTE_ADDR'] . date('dmY') );
